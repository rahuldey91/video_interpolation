...
def main():
    ...
    # first segment
    out_frames[:frameA_new_idx-interp_gap] = stream[:frameA_new_idx-interp_gap]
    ...
    # second segment
    out_frames[frameA_new_idx+interp_gap:frameB_new_idx-interp_gap] = stream[frameA_new_idx+interp_gap:frameB_new_idx-interp_gap]
    ...
    # last segment
    out_frames[frameB_new_idx+interp_gap:last_idx] = stream[frameB_new_idx+interp_gap:last_idx]
